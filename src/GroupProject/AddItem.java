...
public class AddItem extends javax.swing.JPanel {
    ...
    public AddItem() {
        ...
        String[] col={"Item Name","Mfg. Date","Exp. Date","Purchase Price","Selling Price","Quantity"};
        ...
        try
        {
            ...
            String sql1= "select * from bakeryshop.Food;";
            ...
            while(i==1)
            {
                if(rs1.next())
                {
                    ...
                    Manufactring_Date=rs1.getString("manufactureDate");
                  ...
                  // // add a row in the table model
                    model.addRow(new Object[]{Item_Name,Manufactring_Date,Exp_Date,Purchase_Price,Selling_Price,Quantity});
                }
                else
                {
                    i=0;
    ...
    private void initComponents() {
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/recource/manuname.png"))); // NOI18N
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/recource/expirydate.png"))); // NOI18N
        ...
        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/recource/manudate.png"))); // NOI18N
        ...
        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/recource/cash1.png"))); // NOI18N
        ...
        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/recource/cash1.png"))); // NOI18N
        ...
        jLabel8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/recource/shopping-card-hi.png"))); // NOI18N
        ...
        jButton3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/recource/additem.jpg"))); // NOI18N
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/GroupProject/bakery-logo-design-bread-basket-barley-icons-decor-cover.png"))); // NOI18N
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Product Name", "Mfg. Date", "Exp. Date", "Purchase Price", "Selling Price", "Quantity"
            }
        ) {
        ...
        jButton2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/recource/search.png"))); // NOI18N
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try
        {
            ...
            String mfd=jTextField3.getText();
            String expireDate=jTextField4.getText();
            String purchasePrice=jTextField5.getText();
            ...
            String sql="INSERT INTO `Food`(`itemName`, `quantity`, `manufactureDate`, `expiryDate`, `purchasePrice`, `sellingPrice`) VALUES (?,?,?,?,?,?);";
            ...
            while(i==1)
            {
                if(rs1.next())
                {
                    ...
                    model.addRow(new Object[]{Item_Name,Mfg_Date,Exp_Date,Purchase_Price,Selling_Price,Quantity});
                }
                else
                {
                    i=0;
