...
public class SearchProduct extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try
        {
            ...
            String sql = "select * from bakeryshop.Food where itemName ='"+jTextField1.getText()+"'";
            PreparedStatement ps = con.prepareStatement(sql);
            ResultSet rs = ps.executeQuery();
            int i =0;
            // Iterate through the result and check if item name exist in the data base
            if(rs.next())
            {
                i++;
            }
            if(i>0)
            {
                JOptionPane.showMessageDialog(null,"Yes, This Item Exist");
            }
            else
            {
    ...
    public static void main(String args[]) {
        ...
        /* Create and display the form search product*/
