...
/**
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try
        {
            ...
            // select the Add member table from the data base
            String sql="select * from bakeryshop.AddMember where memberid="+jTextField1.getText();
            PreparedStatement ps = con.prepareStatement(sql);
            ResultSet rs = ps.executeQuery();
            int i =0;
            // Iterate through the result and check if member ID exist in the data base
            if(rs.next())
            {
                i++;
            }
